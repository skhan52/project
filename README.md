...
**처음 사용하시나요? 아래에서 적합한 가이드를 선택하세요:**

| 대상 | 문서 | 설명 |
|------|------|------|
| 🎨 **어린이/초보자** | [어린이용 설치가이드](어린이용_설치가이드.md) | 10살 어린이도 따라할 수 있는 쉬운 설명 |
| ⚡ **빠른 시작** | [빠른시작가이드](빠른시작가이드.md) | 한눈에 보는 설치와 사용법 |
| 🔧 **문제 해결** | [문제해결가이드](문제해결가이드.md) | 에러 발생시 해결 방법 플로우차트 |
| 💻 **개발자/고급** | [INSTALLATION.md](INSTALLATION.md) | 상세한 기술 설치 가이드 |
| 🔌 **API 사용** | [API.md](API.md) | REST API 문서 |
| 🔒 **보안** | [SECURITY.md](SECURITY.md) | 보안 관련 정보 |
